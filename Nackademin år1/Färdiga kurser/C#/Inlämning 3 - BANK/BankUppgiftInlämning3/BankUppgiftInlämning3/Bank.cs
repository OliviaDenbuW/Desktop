    ...
    public class Bank
    {
        ...
        public void ReadAccountsFromTextFile(StreamReader textFile)
        {
            ...
            for (int i = 0; i < nrOfAccounts; i++)
            {
                ...
                account.BalanceOfAccount = double.Parse(partOfAccountInfo[2], CultureInfo.InvariantCulture);
        ...
        public void ShowMainMenu()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("0) Exit and save program");
        ...
        public void PerformOperationOfChoice(string inputOperationAsString)
        {
            ...
            do
            {
                if (inputIsNr && (inputOperation >= 0) && (inputOperation <= 9))
                {
                    ...
                    {
                        case 0:
                            Console.WriteLine("Exit and saving program");
                            CreateFileWithCurrentBankInfo();
                            wantToQuitProgram = true;
                            break;
        ...
        /*
        //TODO: Fix or remove
        public void WantToExitProgram()
        {
            Console.Write("Would you like to exit program? (yes/no) ");
        ...
        public void Deposit()
        {
            ...
            double amountToDeposit = double.Parse(inputAmount);
        ...
        public void Withdrawl()
        {
            ...
            while (!acceptedAmountToDeposit)
            {
                ...
                bool inputIsNr = double.TryParse(str, out amountToWithdraw);
        ...
        public void Transfer()
        {
            ...
            {
                if (account.BalanceOfAccount < double.Parse(amountToTransfer))
                {
                    Console.WriteLine();
                ...
                else
                {
                    foreach (var accountFrom in searchResultAccountTakesFrom)
                    {
                        ...
                        accountFrom.BalanceOfAccount -= double.Parse(amountToTransfer);
                    ...
                    foreach (var accountTo in searchResultAccountTransferTo)
                    {
                        ...
                        accountTo.BalanceOfAccount += double.Parse(amountToTransfer);
