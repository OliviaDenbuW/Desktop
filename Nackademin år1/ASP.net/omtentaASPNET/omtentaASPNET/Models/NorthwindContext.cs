...
namespace omtentaASPNET.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Lärare> Lärare { get; set; }
        ...
        public virtual DbSet<Toys1> Toys1 { get; set; }

        public NorthwindContext(DbContextOptions<NorthwindContext> options)
        : base(options)
        { }

        // Unable to generate entity type for table 'dbo.Toys'. Please see the warning messages.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.Property(e => e.Region)
                    .HasMaxLength(15)
                    .HasDefaultValueSql("('Region saknas')");
            });
            ...
            {
                entity.Property(e => e.Personnummer).HasColumnType("char(12)");

                entity.HasOne(d => d.PersonnummerNavigation)
                    .WithMany(p => p.Lärare)
                    .HasForeignKey(d => d.Personnummer)
                    .HasConstraintName("FK__Lärare__Personnu__07C12930");
            });
            ...
            modelBuilder.Entity<Student>(entity =>
            {
                ...
                entity.Property(e => e.Slutbetyg).HasColumnType("char(3)");

                entity.HasOne(d => d.PersonnummerNavigation)
                    .WithMany(p => p.Student)
                    .HasForeignKey(d => d.Personnummer)
                    .HasConstraintName("FK__Student__Personn__04E4BC85");
            });
            ...
            modelBuilder.Entity<Toys1>(entity =>
            {
