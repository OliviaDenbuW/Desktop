...
namespace WebTomasos.Entities
{
    public partial class tomasosContext : DbContext
    {
        ...
        public virtual DbSet<Ingredienser> Ingredienser { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ingredienser>(entity =>
            {
                entity.Property(e => e.Id).HasColumnName("ID");

                entity.Property(e => e.Namn).HasMaxLength(50);

                entity.HasOne(d => d.MatrattNavigation)
                    .WithMany(p => p.Ingredienser)
                    .HasForeignKey(d => d.Matratt)
                    .HasConstraintName("FK__Ingredien__Matra__01142BA1");
            });
