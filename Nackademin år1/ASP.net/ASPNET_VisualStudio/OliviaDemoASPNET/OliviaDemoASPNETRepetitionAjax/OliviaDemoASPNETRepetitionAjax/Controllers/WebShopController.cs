...
using OliviaDemoASPNETRepetitionAjax.Models;

namespace OliviaDemoASPNETRepetitionAjax.Controllers
{
    public class WebShopController : Controller
    {
        ...
        {
            //Den pv är en beskrivning
            var model = ProductList().SingleOrDefault(p => p.ID == id);

            //Ska skicka tillbaka en partial view
