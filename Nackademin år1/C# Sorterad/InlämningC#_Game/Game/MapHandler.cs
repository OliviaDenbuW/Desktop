    ...
    class MapHandler
    {
      ...
      //  int[] mapCord = new[] { 0, 0 };
       ...
       private int xPosScreen = 75;
        ...
        ///</remarks>
        public int[] MapMovement(string input,int [,]map, int[] mapCord)
        {
            bool[] canMoveSides = new bool[4];
            canMoveSides = TryMovement(mapCord, map);
            ...
            if (input == "w" && canMoveSides[0]  )
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Dörren är stängd");
                }
            }
            else if (input == "s" && canMoveSides[1] )
            {
            ...
            else if (input == "a" && canMoveSides[2])
            {
            ...
            else if (input == "d" && canMoveSides[3] )
            {
        ...
        ///</remarks>
        public bool[] TryMovement(int []mapCordToTest ,int[,]map)
        {
            rooms.PopulateDoorList();
            bool[] canMoveSides = new bool[4];
            //upp
